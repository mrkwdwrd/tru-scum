...
<template>
  <Scene :id="id" class="bg-black max-w-[1980px] mx-auto">
    <div class="flex h-full relative">
      ...
      <!-- Image Container -->
      <div class="absolute w-full h-full p-10 left-0 right-0">
        <div class="flex justify-center">

          <!-- Image -->
          <img :src="image" class="w-[1200px] h-[1200px] max-h-[90vh] max-w-[90vh]"/>
          ...
          <div class="max-w-[500px] min-w-[405px] max-h-[90vh] flex flex-col bg-black">
            ...
            <div class="overflow-hidden">
              ...
              <IgComment user="Condimentum" age="27d" :likes="2" :stories="true"/>
              <IgComment user="Condimentum" age="27d" :likes="2" />
            </div>
            ...
            <div class="border-t border-gray-700 text-white pb-5">
              ...
              <div class="font-semibold text-sm px-5">
                378 Likes
              </div>
