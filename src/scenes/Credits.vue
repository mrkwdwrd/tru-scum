...
<template>
  <Scene class="bg-black max-w-[1980px] mx-auto flex items-center content-center w-full">
      <div id="credits" :class="['text-center text-white w-full flex flex-col gap-1 max-w-3xl mx-auto scale-150', { 'fade-in': fade }]">
        ...
        <p class="uppercase font-medium text-3xl">Frankie Lupton</p>
        <h2 class="uppercase font-medium mt-4">Director</h2>
        <p class="uppercase font-medium text-3xl">Keith Brockett</p>
        <h2 class="uppercase font-medium mt-4">Dramaturg</h2>
        <p class="uppercase font-medium text-3xl">Dan Harris</p>
        <h2 class="uppercase font-medium mt-4">Tech Designer</h2>
