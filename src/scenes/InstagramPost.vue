    ...
    <IgUI>
      ...
      <div class="absolute w-full h-full p-10 left-0 right-0">
        <div class="flex justify-center">
          ...
          <!-- Sidebar -->
          <div class="max-w-[500px] min-w-[405px] max-h-[90vh] flex flex-col bg-black justify-between">
            <!-- Account -->
            ...
            <div class="border-t border-gray-700 text-white">
              <div class="flex justify-between p-5">
                <span class="flex gap-4">
                  ...
                  <span class="text-neutral-400 text-sm">Add a comment...</span>
                </span>
