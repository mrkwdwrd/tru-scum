...
<template>
  <Scene :id="id" class="bg-black max-w-[1980px] mx-auto">
    <div class="flex h-full w-full items-center">
      <div class="flex w-full max-w-5xl mx-auto gap-20 items-center justify-start scale-150">
        <div class="flex gap-12 items-center justify-start flex-grow-0 foe">
          <div class="h-12 w-12 flex flex-col gap-3 justify-center">
            <span class="bg-white w-full h-1 block"></span>
            <span class="bg-white w-full h-1 block"></span>
            <span class="bg-white w-full h-1 block"></span>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-48" id="yt-ringo2-svg_yt15" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true">
            <g>
              <path d="M14.4848 20C14.4848 20 23.5695 20 25.8229 19.4C27.0917 19.06 28.0459 18.08 28.3808 16.87C29 14.65 29 9.98 29 9.98C29 9.98 29 5.34 28.3808 3.14C28.0459 1.9 27.0917 0.94 25.8229 0.61C23.5695 0 14.4848 0 14.4848 0C14.4848 0 5.42037 0 3.17711 0.61C1.9286 0.94 0.954148 1.9 0.59888 3.14C0 5.34 0 9.98 0 9.98C0 9.98 0 14.65 0.59888 16.87C0.954148 18.08 1.9286 19.06 3.17711 19.4C5.42037 20 14.4848 20 14.4848 20Z" fill="#FF0033"></path>
              <path d="M19 10L11.5 5.75V14.25L19 10Z" fill="white"></path>
            </g>
            <g id="youtube-paths_yt15" fill="white">
        ...
        <div class="flex gap-5 flex-grow  w-full">
          <div class="text-gray-600 border rounded-full border-gray-400 w-full flex justify-between overflow-hidden">
            <span class="px-6 py-2 flex items-center"><i class="bg-white w-[1px] animate-pulse items-center h-full inline-block"></i>Search</span>
            <span class="bg-gray-600 border-gray-400 border-l  text-white px-4 py-2">
          ...
          <div class="border rounded-full border-gray-600 w-12 flex justify-between overflow-hidden">
            <span class="py-2 w-full flex justify-center text-white bg-gray-600">
              <svg class="goxjub" focusable="false" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg"><path fill="#fff" d="m12 15c1.66 0 3-1.31 3-2.97v-7.02c0-1.66-1.34-3.01-3-3.01s-3 1.34-3 3.01v7.02c0 1.66 1.34 2.97 3 2.97z"></path><path fill="#34a853" d="m11 18.08h2v3.92h-2z"></path><path fill="#fff" d="m7.05 16.87c-1.27-1.33-2.05-2.83-2.05-4.87h2c0 1.45 0.56 2.42 1.47 3.38v0.32l-1.15 1.18z"></path><path fill="#fff" d="m12 16.93a4.97 5.25 0 0 1 -3.54 -1.55l-1.41 1.49c1.26 1.34 3.02 2.13 4.95 2.13 3.87 0 6.99-2.92 6.99-7h-1.99c0 2.92-2.24 4.93-5 4.93z"></path></svg>
            </span>
          </div>
        </div>
      </div>
