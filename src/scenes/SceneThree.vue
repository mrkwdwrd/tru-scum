...
<template>
  <Scene :id="id" class="bg-black max-w-[1980px] mx-auto">
    <div class="flex h-full">
      <nav class="border-r border-gray-800 w-1/6 text-white px-8 py-10 flex flex-col justify-between font-semibold">
        <div>
      ...
      <main class="flex flex-col w-5/6 items-middle p-10">
        <div class="border border-gray-800 mx-auto w-[935px] flex">
          <div class="flex-grow h-[599px]"></div>
          <div class="w-[335px] border-l border-gray-800 flex flex-col">
            <div class="p-4 border-b border-gray-800">
              <span class="block h-8 w-8 bg-white rounded-full"</span>
            </div>
            <div class="flex-grow"></div>
            <div class="border-t border-gray-800 h-20 text-white p-5">
