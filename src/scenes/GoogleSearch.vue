<script setup>
  ...
  const simulateTyping = (arr, i = 0) => {
    ...
    setTimeout(() => {
      showSuggestions.value = !!props.suggestions
    }, 200)
  }
        ...
        <main class="w-full flex items-center">
          <div class="w-full max-w-screen-sm p-10 mx-auto text-white text-lg flex flex-col">
            ...
            <div class="flex items-center bg-zinc-500 has-[:focus]:bg-zinc-700 rounded-[30px] px-4 mt-4 relative" :class="[ {'rounded-b-none': showSuggestions }]">
              ...
              <div v-if="input" class="h-8 w-14 flex justify-center items-center border-r border-zinc-500 ">
                <svg class="h-6 w-6 fill-zinc-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>
                </svg>
              </div>
              <div class="h-14 w-12 flex justify-center items-center">
                <svg class="h-6 w-6 fill-zinc-300" viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="relative h-1 mb-5">
              <div v-if="showSuggestions" class="absolute w-full bg-zinc-700 rounded-b-[30px]">
                <div class="flex flex-col gap-2 py-4 mx-6 border-t border-zinc-300">
                  <div v-for="suggestion in suggestions" class="flex gap-1 items-center font-bold text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 fill-zinc-300">
                      <path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"></path>
                    </svg>
                    {{ suggestion }}
            ...
            <div class="flex justify-center gap-5 text-sm">
              <button class="bg-zinc-800 rounded-md px-4 py-2">Google Search</button>
              <button class="bg-zinc-800 rounded-md px-4 py-2">I'm Feeling Lucky</button>
            </div>
          </div>
        </main>
      </div>
