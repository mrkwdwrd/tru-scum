  ...
  <Scene class="bg-black max-w-[1980px] mx-auto">
      <div class="flex h-full relative">
        <main class="w-full flex items-center">
          <div class="w-full max-w-screen-sm p-10 mx-auto text-white text-lg flex flex-col gap-6">
            ...
            <div class="flex items-center bg-zinc-500 has-[:focus]:bg-zinc-700 rounded-full px-4 relative">
