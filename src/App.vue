...
<template>
  ...
  <main class="cursor-none">
    ...
    <InstagramPost v-if="scene === 7"
      ...
      <IgComment user="ParturientQuam" :age="`${18} days`" :likes="16" :replies="2" comment="SWEET BABY BOI 🥺"/>
      <IgComment user="Condimentum" :age="`${18} days`" :likes="2" :replies="2" :stories="true" comment="Beautiful!!! ♥️"/>
      <IgComment user="Condimentum" :age="`${18} days`" :likes="1" :replies="2" :stories="true" comment="Yasssssssssssssssss"/>
      <IgComment user="Condimentum" :age="`${18} days`" :likes="1" :stories="true" comment="Trans rights are catboi rights!!!"/>
      <IgComment user="Condimentum" :age="`${18} days`" :likes="1" :stories="true" comment="I’m getting into it too! You look gorgeous! 😊♥️"/>
    </InstagramPost>
    ...
    <InstagramPost v-if="scene === 17"
      ...
      :likes="222"
      caption="Cras mattis consectetur purus sit amet fermentum.">
      <IgComment user="ParturientQuam" :age="`${10} minutes`" :likes="2" comment="I cannot imagine what you must be going through right now, Robin. Sending love, hugs, prayers…everything. 🫂♥️"/>
      <IgComment user="Condimentum":age="`${9} minutes`" :likes="2" :replies="1" :stories="true" comment="Oh my god I can’t believe it please let him be safe!!! Take care of yourself 💟"/>
      <IgComment user="Condimentum" :age="`${9} minutes`" :likes="4" :replies="2" :stories="true" comment="im crying…juni’s such a beacon of hope and positivity for me as a closeted enby i can’t even imagine…i hope he’s safe and i love you robin pls take care of yourself 🥺"/>
      <IgComment user="Condimentum" :age="`${8} minutes`" :likes="18" :replies="6" :stories="true" comment="Greg needs to delete his channel. I wouldn’t even believe it if he apologised at this point. He’s an absolute cancer to our community. More people need to see what happens when unhinged narcissistic trolls like him get a platform. They’re the ones who ACTUALLY make us look bad. Take a long hard look at yourself and log off. #ByeGreg"/>
    </InstagramPost>
