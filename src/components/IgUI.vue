<script setup>
  ...
  import image1 from '@/assets/images/IMG_12C199CFA5F9-1.jpg'
  ...
  import image2 from '@/assets/images/openart-image_6m7WAF1y_1731749595772_raw.jpg'
  import image6 from '@/assets/images/openart-image_X1KAOd8n_1731313086490_raw.jpg'
...
<template>
  <div class="flex h-full relative">
    ...
    <main class="w-5/6 text-white">
      <IgBio class="border-b" :image="profileImage"/>
      <!--Sections -->
      ...
      <div class="flex w-full max-w-screen-lg mx-auto flex-wrap">
        <div class="w-1/3 aspect-square p-[0.075rem]">
        ...
        <div class="w-1/3 aspect-square p-[0.075rem]">
            <img :src="image4" class="w-full h-full"/>
        </div>
        <div class="w-1/3 aspect-square p-[0.075rem]">
            <img :src="image5" class="w-full h-full"/>
        </div>
        <div class="w-1/3 aspect-square p-[0.075rem]">
            <img :src="image6" class="w-full h-full"/>
        </div>
      </div>
    </main>
    <slot></slot>
